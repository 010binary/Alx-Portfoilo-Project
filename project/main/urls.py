...
urlpatterns = [
    ...
    path('vote/<int:competition_id>/<int:candidate_id>/',
         views.vote, name='cast_vote'),
    ...
    path('api/competitions/', views.get_competition_list, name='get_competition_list'),
    path('api/competitions/ranking/<int:competition_id>/',
         views.get_competition_ranking, name='get_competition_ranking'),
    path('api/competitions/result/<int:competition_id>/',
         views.get_competition_result, name='get_competition_result'),
]
